...
public class Mouth extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    public Mouth(String name, Simulator simulator) {
    ...
    public static void main(String[] args) {
        ...
        Mouth model = new Mouth();
        model.options = options;

        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("Mouth Simulation", model, options);
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = Mouth.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                Mouth.class.getResource(".").toString());
        }
