...
public class Stomach extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    // Output ports
    //ID:OUTP:0
    public final Port<Satiation> outSatiation =
        addOutputPort("outSatiation", Satiation.class);

    //ENDID
    //ID:OUTP:1
    public final Port<Serializable> outFood =
        addOutputPort("outFood", Serializable.class);
    ...
    public Stomach(String name) {
        this(name, null);
    }

    public Stomach(String name, Simulator simulator) {
    ...
    public void internalTransition() {
        ...
        if (phaseIs("digestFood")) {
            getSimulator().modelMessage("Internal transition from digestFood");
    ...
    public static void main(String[] args) {
        ...
        Stomach model = new Stomach();
        model.options = options;

        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("Stomach Simulation", model, options);
    ...
    public String[] getStateVariableNames() {
        return new String[] { "measureFood", "measureSatiation" };
    }

    public Object[] getStateVariableValues() {
        return new Object[] { measureFood, measureSatiation };
    }

    public Class<?>[] getStateVariableTypes() {
        return new Class<?>[] { Food.class, Satiation.class };
    }
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = Stomach.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                Stomach.class.getResource(".").toString());
        }
    ...
    public String[] getPhaseNames() {
        return new String[] { "InitialState", "digestFood" };
    }
}
