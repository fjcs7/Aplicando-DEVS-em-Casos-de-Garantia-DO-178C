...
public class NervousSystem extends CoupledModelImpl implements StateVariableBased{ 
	private static final long serialVersionUID = 1L;
	protected SimulationOptionsImpl options = new SimulationOptionsImpl();
	
		public final Port<? extends Serializable> outHunger= addOutputPort("outHunger",Serializable.class);
		public final Port<? extends Serializable> inSatiation= addInputPort("inSatiation",Serializable.class);
		public final Port<? extends Serializable> inLowNutrients= addInputPort("inLowNutrients",Serializable.class);
	public NervousSystem(){
		this("NervousSystem");
	}
	public NervousSystem(String nm) {
		super(nm);
		make();
	}
	public void make(){
		...
		addChildModel(Brain);
		addCoupling(Brain.outHunger,this.outHunger);
		addCoupling(this.inSatiation,Brain.inSatiation);
		addCoupling(this.inLowNutrients,Brain.inLowNutrients);
	...
	public static void main(String[] args){
		...
		NervousSystem model = new NervousSystem();
		model.options = options;
		if(options.isDisableViewer()){ // Command Line output only
			Simulation sim = new com.ms4systems.devs.core.simulation.impl.SimulationImpl("NervousSystem Simulation",model,options);
