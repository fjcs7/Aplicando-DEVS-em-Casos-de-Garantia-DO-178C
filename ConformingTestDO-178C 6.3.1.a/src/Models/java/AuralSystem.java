...
public class AuralSystem extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    public static void main(String[] args) {
        ...
        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("AuralSystem Simulation", model, options);
    ...
    protected static File getModelsDirectory() {
        ...
        try {
            ...
            throw new RuntimeException(
                ...
                AuralSystem.class.getResource(".").toString());
        }
