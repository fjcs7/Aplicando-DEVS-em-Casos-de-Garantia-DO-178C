...
protected YawAngleRight angleActualMeasure
;
//ENDID
...
// End output event code
 ...
 public static void main(String[] args) {
   ...
   // Getter/setter for angleActualMeasure
    public void setAngleActualMeasure(YawAngleRight angleActualMeasure) {
    ...
    public YawAngleRight getAngleActualMeasure() {
    ...
    public Class<?>[] getStateVariableTypes() {
    	return new Class<?>[] {
    		AngleExecution.class,YawAngleRight.class
    	};
    }
    ...
    public void setStateVariableValue(int index, Object value) {
    	switch(index) {
    		...
    		case ID_ANGLEACTUALMEASURE:
			    setAngleActualMeasure((YawAngleRight)value);
    			return;
