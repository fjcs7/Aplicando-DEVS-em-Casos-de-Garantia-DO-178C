...
public class ServoComandoAileronR extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    // Output ports
    //ID:OUTP:0
    public final Port<ExecutedCmdRight> outExecutedCmdRight =
        addOutputPort("outExecutedCmdRight", ExecutedCmdRight.class);
    ...
    public ServoComandoAileronR() {
        this("ServoComandoAileronR");
    }

    public ServoComandoAileronR(String name) {
        this(name, null);
    }

    public ServoComandoAileronR(String name, Simulator simulator) {
    ...
    public static void main(String[] args) {
        ...
        ServoComandoAileronR model = new ServoComandoAileronR();
        model.options = options;

        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("ServoComandoAileronR Simulation", model,
                    options);
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = ServoComandoAileronR.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                ServoComandoAileronR.class.getResource(".").toString());
        }
