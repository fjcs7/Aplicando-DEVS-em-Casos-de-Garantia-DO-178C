...
public class Joystick extends AtomicModelImpl
...
public Joystick(){ this("Joystick"); }
 ...
 @Override
    public void internalTransition() {
		...
		if (phaseIs("SendCommand")) {
		    getSimulator().modelMessage("Internal transition from SendCommand");
...
// End output event code
 ...
 public static void main(String[] args) {
        ...
        if (options.isDisableViewer()) { // Command line output only
            Simulation sim = new com.ms4systems.devs.core.simulation.impl.SimulationImpl("Joystick Simulation", model, options);
   ...
   // Getter/setter for sendCommand
    ...
    protected static File getModelsDirectory() {
        ...
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Could not find Models directory. Invalid model URL: " + Joystick.class.getResource(".").toString());
        }
