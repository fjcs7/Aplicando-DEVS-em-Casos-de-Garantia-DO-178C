...
DNL
platform:/resource/ConformingTestDO-178C%206.3.1.a/src/Models/dnl/Wings.dnl
-2053973754
 Do not remove or modify this comment!  It is required for file identification! */
package Models.java;
...
public class Wings extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    // Output ports
    //ID:OUTP:0
    public final Port<Serializable> outYawAngleRight =
        addOutputPort("outYawAngleRight", Serializable.class);
    ...
    public Wings(String name, Simulator simulator) {
    ...
    public static void main(String[] args) {
        ...
        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("Wings Simulation", model, options);
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = Wings.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                Wings.class.getResource(".").toString());
        }
