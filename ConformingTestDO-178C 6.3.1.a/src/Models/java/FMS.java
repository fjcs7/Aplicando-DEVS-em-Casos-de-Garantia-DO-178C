...
public class FMS extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    //ENDID
    //ID:INP:1
    public final Port<CmdOnOff> inCmdOnOff =
        addInputPort("inCmdOnOff", CmdOnOff.class);
    ...
    // Output ports
    //ID:OUTP:0
    public final Port<Sound> outRightSound =
        addOutputPort("outRightSound", Sound.class);

    //ENDID
    //ID:OUTP:1
    public final Port<Sound> outLeftSound =
        addOutputPort("outLeftSound", Sound.class);
    ...
    public static void main(String[] args) {
        ...
        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new com.ms4systems.devs.core.simulation.impl.SimulationImpl("FMS Simulation",
                    model, options);
    ...
    public String[] getStateVariableNames() {
        return new String[] { "sedCommand" };
    }

    public Object[] getStateVariableValues() {
        return new Object[] { sedCommand };
    }
    ...
    protected static File getModelsDirectory() {
        ...
        try {
            ...
            throw new RuntimeException(
                ...
                FMS.class.getResource(".").toString());
        }
