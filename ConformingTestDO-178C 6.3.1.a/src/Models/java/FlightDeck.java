...
public class FlightDeck extends CoupledModelImpl implements StateVariableBased{ 
	...
	public void make(){
		...
		addCoupling(this.inFeedbackRoll,Pilot.inFeedbackRoll);
		addCoupling(FMS.outCmdJoystick,Joystick.inCmdJoystick);
		addCoupling(Pilot.outCmdOnOff,FMS.inCmdOnOff);
		addCoupling(Joystick.outCmdJoystick,this.outCmdJoystick);
